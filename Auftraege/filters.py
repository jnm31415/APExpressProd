...
class SearchPosition(django_filters.FilterSet):
    ...
    unterschrift_datum = DateFilter(field_name='unterschrift_datum', initial=date.today, widget=forms.TextInput(attrs={'class':'form-control form-control-sm','type':'date'}))
