  ...
  def generate_pdf(request):
      ...
      for i in range(len(pos.values('id'))):
        ...
        invoice_data += [{'pos': i+1, \
                          ...
                          'total':'{0:.{1}f}'.format(pos.values('anzahl')[i]['anzahl']*pos.values('einzelpreis')[i]['einzelpreis']+pos.values('anzahl')[i]['anzahl']*pos.values('einzelpreis')[i]['einzelpreis']/100*pos.values('mwst')[i]['mwst']+pos.values('pauschale')[i]['pauschale']+pos.values('pauschale')[i]['pauschale']/100*pos.values('mwst')[i]['mwst']) , \
